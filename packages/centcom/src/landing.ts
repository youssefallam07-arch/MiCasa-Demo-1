...
.app.c .ic{background:rgba(77,159,255,.12);color:var(--accent)}.app.w .ic{background:rgba(61,214,140,.12);color:var(--green)}.app.a .ic{background:rgba(217,179,106,.12);color:var(--gold)}
